...
import { eventService, Event, CreateEventRequest, EventCategory } from '../services/eventService';
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
        ...
        <form onSubmit={handleSubmit}>
          <DialogContent>
            ...
            <TextField
              margin="dense"
              label="Registration Form URL (Optional)"
              fullWidth
              variant="outlined"
              value={formData.registrationFormUrl}
              onChange={(e) => setFormData({ ...formData, registrationFormUrl: e.target.value })}
              placeholder="https://forms.gle/your-form-id"
            />
            <TextField
              margin="dense"
              label="Photo Gallery URL (Optional)"
              fullWidth
              variant="outlined"
              value={formData.photoGalleryUrl}
              onChange={(e) => setFormData({ ...formData, photoGalleryUrl: e.target.value })}
